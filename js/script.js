...
document
  .querySelectorAll(".animate-num")
  .forEach((el) => numObserver.observe(el));

const actionViews = {
  admin:
    '<div class="av-grid">' +
    '<div class="av-card"><div class="av-card-title">Total Students</div><div class="av-card-value animate-num" data-val="1240">1,240</div></div>' +
    ...
    '<div class="av-card"><div class="av-card-title">Active Teachers</div><div class="av-card-value animate-num" data-val="85">85</div></div>' +
    "</div>" +
  ...
  searchInput.addEventListener("input", (e) => {
    ...
    if (filtered.length > 0) {
      filtered.forEach((item) => {
        searchResults.innerHTML +=
          '<div class="search-results-item"><div class="sr-title">' +
          item.title +
      ...
      searchResults.innerHTML =
        '<div class="search-results-item"><div class="sr-desc">No results found.</div></div>';
    }
  ...
  admin: {
    ...
    html: `
            <div class="pd-kpi-grid">
                <div class="pd-kpi"><div class="pd-kpi-header"><span>Total Students</span><div class="pd-kpi-icon"><i class="fa-solid fa-users"></i></div></div><div class="pd-kpi-value animate-num" data-val="1240">1,240</div><div class="pd-kpi-trend"><i class="fa-solid fa-arrow-trend-up"></i> +4.2% this month</div></div>
                ...
                <div class="pd-kpi"><div class="pd-kpi-header"><span>Active Teachers</span><div class="pd-kpi-icon"><i class="fa-solid fa-chalkboard-user"></i></div></div><div class="pd-kpi-value animate-num" data-val="85">85</div><div class="pd-kpi-trend" style="color:var(--text-tertiary)"><i class="fa-solid fa-minus"></i> No change</div></div>
            ...
            <div class="pd-grid-main">
                <div class="pd-widget">
                    ...
                    <div class="pd-timeline">
                        <div class="pd-tl-item"><div class="pd-tl-time">10:42</div><div class="pd-tl-dot"></div><div class="pd-tl-content"><div class="pd-tl-title">Semester Reports Generated</div><div class="pd-tl-desc">Automated system generated 1,240 reports.</div></div></div>
